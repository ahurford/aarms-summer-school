...
This covers will cover different formulations and analyses for mathematical models in epidemiology. Some lectures will be based on [Modelling Infectious Diseases in Humans and Animals](http://www.modelinginfectiousdiseases.org/) by Matt Keeling and Pej Rohani (available as .pdf from MUN library)
