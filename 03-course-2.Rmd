...
- Lecture 8. Ch 9. Fusing data sources.
...
- Lecture 12. Case studies (i.e., see Ecological Forecasting book)
...
**Problems 8. Critical review of COVID-19 models for decision support (i.e., uncertainty quantification)**

- Lecture 16. Models and misinformation
